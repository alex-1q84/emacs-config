...
- [[#init-uiel][init-ui.el]]
  ...
  - [[#图标设置][图标设置]]
  - [[#shackle窗口管理][shackle窗口管理]]
  - [[#popper窗口弹出管理][popper窗口弹出管理]]
  - [[#winner窗口管理][winner窗口管理]]
...
- [[#init-devel][init-dev.el]]
  ...
  - [[#shell语言设置][Shell语言设置]]
  - [[#copilot-废弃没有安装起来][copilot =废弃，没有安装起来=]]
...
- [[#init-shellel][init-shell.el]]
  ...
  - [[#capf-autosuggest自动补全][capf-autosuggest自动补全]]
...
h         ("i" . (lambda () (interactive) (org-capture nil "d")))
...
[[https://github.com/zerolfx/copilot.el][项目源代码]]
#+BEGIN_SRC emacs-lisp
(use-package copilot
  ...
  ;; (with-eval-after-load 'corfu-quick-complete
